...
public class SlidingUpPanelLayout extends ViewGroup implements ScrollableChild {
	...
	public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		int baseSettleDuration = -1;
		int maxSettleDuration = -1;
		...
		if (attrs != null) {
			...
			if (ta != null) {
				...
				baseSettleDuration = ta.getInteger(R.styleable.SlidingUpPanelLayout_umanoBaseSettleDuration, -1);
				maxSettleDuration = ta.getInteger(R.styleable.SlidingUpPanelLayout_umanoMaxSettleDuration, -1);
		...
		if (baseSettleDuration > 0) {
			mDragHelper.setBaseSettleDuration(baseSettleDuration);
		}
		if (maxSettleDuration > 0) {
			mDragHelper.setMaxSettleDuration(maxSettleDuration);
		}
